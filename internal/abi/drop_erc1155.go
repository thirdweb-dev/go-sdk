...
func (_DropERC1155 *DropERC1155Caller) ThirdwebFee(opts *bind.CallOpts) (common.Address, error) {
	var out []interface{}
	err := _DropERC1155.contract.Call(opts, &out, "thirdwebFee")
...
//
// Solidity: function thirdwebFee() view returns(address)
func (_DropERC1155 *DropERC1155Session) ThirdwebFee() (common.Address, error) {
	return _DropERC1155.Contract.ThirdwebFee(&_DropERC1155.CallOpts)
}

// ThirdwebFee is a free data retrieval call binding the contract method 0xcf8267b1.
//
// Solidity: function thirdwebFee() view returns(address)
func (_DropERC1155 *DropERC1155CallerSession) ThirdwebFee() (common.Address, error) {
	return _DropERC1155.Contract.ThirdwebFee(&_DropERC1155.CallOpts)
}
