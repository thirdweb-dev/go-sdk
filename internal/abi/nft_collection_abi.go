...
func (_NFTCollection *NFTCollectionTransactor) CreateNativeTokens(opts *bind.TransactOpts, to common.Address, _nftURIs []string, _nftSupplies []*big.Int, data []byte) (*types.Transaction, error) {
	return _NFTCollection.contract.Transact(opts, "createNativeTokens", to, _nftURIs, _nftSupplies, data)
}
...
func (_NFTCollection *NFTCollectionSession) CreateNativeTokens(to common.Address, _nftURIs []string, _nftSupplies []*big.Int, data []byte) (*types.Transaction, error) {
	return _NFTCollection.Contract.CreateNativeTokens(&_NFTCollection.TransactOpts, to, _nftURIs, _nftSupplies, data)
}
...
func (_NFTCollection *NFTCollectionTransactor) Multicall(opts *bind.TransactOpts, data [][]byte) (*types.Transaction, error) {
	return _NFTCollection.contract.Transact(opts, "multicall", data)
}
...
func (_NFTCollection *NFTCollectionSession) Multicall(data [][]byte) (*types.Transaction, error) {
	return _NFTCollection.Contract.Multicall(&_NFTCollection.TransactOpts, data)
}
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *NFTCollectionRestrictedTransferUpdatedIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(NFTCollectionRestrictedTransferUpdated)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *NFTCollectionRestrictedTransferUpdatedIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *NFTCollectionRestrictedTransferUpdatedIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}
...
func (_NFTCollection *NFTCollectionFilterer) FilterRestrictedTransferUpdated(opts *bind.FilterOpts) (*NFTCollectionRestrictedTransferUpdatedIterator, error) {
	...
	logs, sub, err := _NFTCollection.contract.FilterLogs(opts, "RestrictedTransferUpdated")
	if err != nil {
		return nil, err
	}
	return &NFTCollectionRestrictedTransferUpdatedIterator{contract: _NFTCollection.contract, event: "RestrictedTransferUpdated", logs: logs, sub: sub}, nil
}
...
func (_NFTCollection *NFTCollectionFilterer) WatchRestrictedTransferUpdated(opts *bind.WatchOpts, sink chan<- *NFTCollectionRestrictedTransferUpdated) (event.Subscription, error) {
	...
	logs, sub, err := _NFTCollection.contract.WatchLogs(opts, "RestrictedTransferUpdated")
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(NFTCollectionRestrictedTransferUpdated)
				if err := _NFTCollection.contract.UnpackLog(event, "RestrictedTransferUpdated", log); err != nil {
					return err
				}
				event.Raw = log
