...
func (_Currency *CurrencyCaller) DOMAINSEPARATOR(opts *bind.CallOpts) ([32]byte, error) {
	var out []interface{}
	err := _Currency.contract.Call(opts, &out, "DOMAIN_SEPARATOR")
...
func (_Currency *CurrencySession) DOMAINSEPARATOR() ([32]byte, error) {
	return _Currency.Contract.DOMAINSEPARATOR(&_Currency.CallOpts)
}
...
func (_Currency *CurrencyCaller) Nonces(opts *bind.CallOpts, owner common.Address) (*big.Int, error) {
	var out []interface{}
	err := _Currency.contract.Call(opts, &out, "nonces", owner)
...
func (_Currency *CurrencySession) Nonces(owner common.Address) (*big.Int, error) {
	return _Currency.Contract.Nonces(&_Currency.CallOpts, owner)
}
...
func (_Currency *CurrencyCaller) TransfersRestricted(opts *bind.CallOpts) (bool, error) {
	var out []interface{}
	err := _Currency.contract.Call(opts, &out, "transfersRestricted")
...
func (_Currency *CurrencySession) TransfersRestricted() (bool, error) {
	return _Currency.Contract.TransfersRestricted(&_Currency.CallOpts)
}
...
func (_Currency *CurrencyTransactor) Multicall(opts *bind.TransactOpts, data [][]byte) (*types.Transaction, error) {
	return _Currency.contract.Transact(opts, "multicall", data)
}
...
func (_Currency *CurrencySession) Multicall(data [][]byte) (*types.Transaction, error) {
	return _Currency.Contract.Multicall(&_Currency.TransactOpts, data)
}
...
func (_Currency *CurrencyTransactor) Permit(opts *bind.TransactOpts, owner common.Address, spender common.Address, value *big.Int, deadline *big.Int, v uint8, r [32]byte, s [32]byte) (*types.Transaction, error) {
	return _Currency.contract.Transact(opts, "permit", owner, spender, value, deadline, v, r, s)
}
...
func (_Currency *CurrencySession) Permit(owner common.Address, spender common.Address, value *big.Int, deadline *big.Int, v uint8, r [32]byte, s [32]byte) (*types.Transaction, error) {
	return _Currency.Contract.Permit(&_Currency.TransactOpts, owner, spender, value, deadline, v, r, s)
}
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *CurrencyRestrictedTransferUpdatedIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(CurrencyRestrictedTransferUpdated)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *CurrencyRestrictedTransferUpdatedIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *CurrencyRestrictedTransferUpdatedIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}
...
func (_Currency *CurrencyFilterer) FilterRestrictedTransferUpdated(opts *bind.FilterOpts) (*CurrencyRestrictedTransferUpdatedIterator, error) {
	...
	logs, sub, err := _Currency.contract.FilterLogs(opts, "RestrictedTransferUpdated")
	if err != nil {
		return nil, err
	}
	return &CurrencyRestrictedTransferUpdatedIterator{contract: _Currency.contract, event: "RestrictedTransferUpdated", logs: logs, sub: sub}, nil
}
...
func (_Currency *CurrencyFilterer) WatchRestrictedTransferUpdated(opts *bind.WatchOpts, sink chan<- *CurrencyRestrictedTransferUpdated) (event.Subscription, error) {
	...
	logs, sub, err := _Currency.contract.WatchLogs(opts, "RestrictedTransferUpdated")
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(CurrencyRestrictedTransferUpdated)
				if err := _Currency.contract.UnpackLog(event, "RestrictedTransferUpdated", log); err != nil {
					return err
				}
				event.Raw = log
