...
// ISignatureMintMintRequest is an auto generated low-level Go binding around an user-defined struct.
type ISignatureMintMintRequest struct {
	To                     common.Address
...
func (_TokenERC20 *TokenERC20Caller) Verify(opts *bind.CallOpts, _req ISignatureMintMintRequest, _signature []byte) (struct {
	Success bool
...
//
// Solidity: function verify((address,address,uint256,address,uint256,string,uint256,uint256,address,uint128,uint128,bytes32) _req, bytes _signature) view returns(bool success, address signer)
func (_TokenERC20 *TokenERC20Session) Verify(_req ISignatureMintMintRequest, _signature []byte) (struct {
	Success bool
	Signer  common.Address
}, error) {
...
//
// Solidity: function verify((address,address,uint256,address,uint256,string,uint256,uint256,address,uint128,uint128,bytes32) _req, bytes _signature) view returns(bool success, address signer)
func (_TokenERC20 *TokenERC20CallerSession) Verify(_req ISignatureMintMintRequest, _signature []byte) (struct {
	Success bool
	Signer  common.Address
}, error) {
	return _TokenERC20.Contract.Verify(&_TokenERC20.CallOpts, _req, _signature)
...
func (_TokenERC20 *TokenERC20Transactor) MintWithSignature(opts *bind.TransactOpts, _req ISignatureMintMintRequest, _signature []byte) (*types.Transaction, error) {
...
//
// Solidity: function mintWithSignature((address,address,uint256,address,uint256,string,uint256,uint256,address,uint128,uint128,bytes32) _req, bytes _signature) payable returns()
func (_TokenERC20 *TokenERC20Session) MintWithSignature(_req ISignatureMintMintRequest, _signature []byte) (*types.Transaction, error) {
...
//
// Solidity: function mintWithSignature((address,address,uint256,address,uint256,string,uint256,uint256,address,uint128,uint128,bytes32) _req, bytes _signature) payable returns()
func (_TokenERC20 *TokenERC20TransactorSession) MintWithSignature(_req ISignatureMintMintRequest, _signature []byte) (*types.Transaction, error) {
	return _TokenERC20.Contract.MintWithSignature(&_TokenERC20.TransactOpts, _req, _signature)
}
...
type TokenERC20TokensMintedWithSignature struct {
	...
	MintRequest   ISignatureMintMintRequest
	Raw           types.Log // Blockchain specific contextual infos
}
...
func (_TokenERC20 *TokenERC20Filterer) FilterTokensMintedWithSignature(opts *bind.FilterOpts, signer []common.Address, mintedTo []common.Address, tokenIdMinted []*big.Int) (*TokenERC20TokensMintedWithSignatureIterator, error) {
	...
	logs, sub, err := _TokenERC20.contract.FilterLogs(opts, "TokensMintedWithSignature", signerRule, mintedToRule, tokenIdMintedRule)
	if err != nil {
		return nil, err
	}
...
//
// Solidity: event TokensMintedWithSignature(address indexed signer, address indexed mintedTo, uint256 indexed tokenIdMinted, (address,address,uint256,address,uint256,string,uint256,uint256,address,uint128,uint128,bytes32) mintRequest)
func (_TokenERC20 *TokenERC20Filterer) WatchTokensMintedWithSignature(opts *bind.WatchOpts, sink chan<- *TokenERC20TokensMintedWithSignature, signer []common.Address, mintedTo []common.Address, tokenIdMinted []*big.Int) (event.Subscription, error) {
	...
	logs, sub, err := _TokenERC20.contract.WatchLogs(opts, "TokensMintedWithSignature", signerRule, mintedToRule, tokenIdMintedRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
