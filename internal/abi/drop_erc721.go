...
func (_DropERC721 *DropERC721Caller) ThirdwebFee(opts *bind.CallOpts) (common.Address, error) {
	var out []interface{}
	err := _DropERC721.contract.Call(opts, &out, "thirdwebFee")
...
//
// Solidity: function thirdwebFee() view returns(address)
func (_DropERC721 *DropERC721Session) ThirdwebFee() (common.Address, error) {
	return _DropERC721.Contract.ThirdwebFee(&_DropERC721.CallOpts)
}

// ThirdwebFee is a free data retrieval call binding the contract method 0xcf8267b1.
//
// Solidity: function thirdwebFee() view returns(address)
func (_DropERC721 *DropERC721CallerSession) ThirdwebFee() (common.Address, error) {
	return _DropERC721.Contract.ThirdwebFee(&_DropERC721.CallOpts)
}
